...
/***************************************************************CUSTOM FUNCTIONS*************************/
void LCD_FillRect(uint16_t Xpos, uint16_t Ypos, uint16_t w, uint16_t h, uint16_t color){
	uint16_t i, j;
...
void LCD_EmptyRect(uint16_t Xpos, uint16_t Ypos, uint16_t w, uint16_t h, uint16_t color, uint8_t thickness){
	LCD_FillRect(Xpos, Ypos, thickness, h, color); //Vertical left line
	LCD_FillRect(Xpos, Ypos, w, thickness, color); //Horizontal top line
	LCD_FillRect(Xpos + w - thickness, Ypos, thickness, h, color); //Vertical right line
	LCD_FillRect(Xpos, Ypos + h - thickness, w, thickness, color); //Horizontal bottom line
}
